        ...
        <script>
            ...
            if (topThreeStrategies.length > 0) {
                topThreeStrategies.forEach((item,index) => {
                    ...
                    onclick="navigateToStrategy('${item.strategy.toLowerCase().replace(' ', '')}.php')">
                    ...
                    <a href="${item.strategy.toLowerCase().replace(" ","")}.php" style="font-size:18px;display:block;" class="learnmore">Learn more</a>
                    </p>
                    </div>`;
                });
            } else {
