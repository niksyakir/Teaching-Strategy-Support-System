    ...
    function addNewQuestion() {
        ...
        const newQuestionHTML = `
            <div class="quiz-question">
                ...
                <input type="text" id="question-${questionCount}" placeholder="Enter the question">
                <br>
                <label>Option 1: </label><input type="text" id="option-${questionCount}-1">
                <label>Option 2: </label><input type="text" id="option-${questionCount}-2">
                <label>Option 3: </label><input type="text" id="option-${questionCount}-3">
                <label>Option 4: </label><input type="text" id="option-${questionCount}-4">
                <br>
